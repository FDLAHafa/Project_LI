            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">SAMAN KESALAHAN LALULINTAS</h1>
                                        ...
                                        <form name = "traffic" action ="LLSave.php" method="post" role="form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value="">1. MELETAK DI TEMPAT LARANGAN/DIKHASKAN KEPADA....................
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value="">2. MELETEAK DI LUAR PETAK/PETAK KUNING
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value="">3. MENGHALANG LALUAN..............................
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value="">4. TIADA LESEN MEMANDU/TAMAT TEMPOH
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value="">5. LESEN(L) MEMBAWA PEMBONCENG
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value="">6. TIADA CUKAI JALAN YANG SAH/TAMAT TEMPOH
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value="">7. MELANGGAR JALAN SEHALA/DILARANG MASUK
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value="">8. TIDAK MEMAKAI TOPI KELEDAR(PENUNGGANG/PEMBONCENG)
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value="">9. TIADA PELEKAT UiTM SESI..................
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value="">10. MELETAK DI KORIDOR/LALUAN PEJALAN KAKI
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value="">11. KENDERAAN DIKUNCI
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value="">12.<input type="text" class="#">
                                                    </label>
                                                </div>
                                            <div class="form-group input-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value="">Di Kunci
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value="">Di Saman
                                                    </label>
                                                </div>
                                            </div>
                                            </div>
